...
@RequestMapping("/board")	// 모든 mapping에 /board가 prefix로 추가된다.
@Controller
public class BoardController {
	...
	@GetMapping("/list.do")
	public String list(Model model) {	// Model : jsp로 전달(forward)할 데이터(속성, attribute)를 저장한다. 목록보기, 상세보기 는 model 필요함
