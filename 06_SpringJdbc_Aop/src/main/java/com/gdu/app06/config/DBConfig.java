...
public class DBConfig {
	...
	/*
	 	...
	 	2. 포인트컷(PointCut)	 : 조인포인트 중에서 AOP르 동작시킬 메소드  - 삽입, 수정, 삭제
	...
	public Advisor advisor() {
		...
		pointCut.setExpression("execution(* com.gdu.app06.service.BoardServiceImpl.*Tx(..))");	// BoardServiceImpl 클래스에 있는 메소드 중에소 이름이 Tx로 끝나는 메소드
